...
def mlx_audio_generate(model: str, text: str, out_dir: Path = None, audio_stem: str="audio", audio_format: str="wav", verbose: bool = False) -> None:
    ...
    cmd = [
        ...
        "--model", model,
        "--text", text,
        "--file_prefix", f"{out_dir}/{audio_stem}",
...
def main():
    args = parse_args()
    audio_path = mlx_audio_generate(args.model, args.text, out_dir=args.out_dir, verbose=args.verbose)
    print(audio_path)
